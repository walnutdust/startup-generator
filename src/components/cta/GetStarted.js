...
const GetStarted = ({
  ...
  const cta = startUp.cta;
  const heading = cta.header;
  const pushDownFooter = random.nextBool();

  return (
    <Container css={pushDownFooter && tw`mb-20 lg:mb-24`}>
      <ContentWithPaddingXl>
        <PrimaryBackgroundContainer css={theme.bgColor500}>
          <Row>
            <TextContainer>
              <Text>{heading}</Text>
            </TextContainer>
            <LinksContainer>
              ...
              <SecondaryLink
                css={[
                  theme.hocusTextColor500,
                  theme.hocusBorder500,
                  theme.borderColor100,
                ]}
          ...
          <DecoratorBlobContainer>
            <DecoratorBlob1 css={theme.textColor700} />
            <DecoratorBlob2 css={theme.textColor700} />
          </DecoratorBlobContainer>
