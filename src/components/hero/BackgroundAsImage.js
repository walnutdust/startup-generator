...
import Header, { NavToggle } from "../headers/light.js";
...
const BackgroundAsImage = () => {
  ...
  const notification = startUp.notification;
  ...
  return (
    ...
    >
      <OpacityOverlay css={theme.bgColor900} />
      <HeroContainer>
        ...
        <TwoColumn>
          <LeftColumn>
            ...
            <Heading>
              <span>{slogan.start}</span>
              <br />
              <SlantedBackground css={theme.textColor500}>
                {slogan.emphasis}
              </SlantedBackground>
            </Heading>
          </LeftColumn>
